...
<div class="container">
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">صفحة معالي الرئيس </h5>
            </div>
        </div>
        <div class="col-md-6">
            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                ...
                <div>
                    <ul class="nav nav-pills p-0">
                        <li class="nav-item">
                            <a aria-current="page" href="{{url('/ar/report')}}" class="router-link-active router-link-exact-active nav-link active ms-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Grid">
                                التقارير
                            </a>
                        </li>
                        <li class="nav-item">
